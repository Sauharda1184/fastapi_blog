...
from schemas import PostResponse, PaginatedPostsResponse, UserCreate, UserPublic, UserPrivate, UserUpdate, Token, ChangePasswordRequest, ForgotPasswordRequest, ResetPasswordRequest
from datetime import timedelta, UTC, datetime
from fastapi.security import OAuth2PasswordRequestForm

from sqlalchemy import func 
from auth import CurrentUser, hash_password, create_access_token,  verify_password, generate_reset_token, hash_reset_token
